        ...
        <div class="container"><a class="navbar-brand logo" href="#"></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navbarNav"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="/src/about.php">Об опыте и мне</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="/src/projects.php.php">Проекты</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="/src/contact.php.php">Связаться</a></li>
